...
(async () => {
  ...
  await fs.writeFile("pleural-effusion-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("pleural-effusion-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
